...
/** Classifies Hook bindings for effect and ownership rules. @param {unknown} name Candidate binding name. @returns {boolean} Whether the name follows the Hook convention. @example isCustomHookName('useCart') // true */
 ...
 * @returns {boolean}
 */
export const isUseCallbackCallee = (callee) =>
  isHookCallee(callee, 'useCallback')
